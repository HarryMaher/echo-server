...
def client(msg, log_buffer=sys.stderr):
    ...
    try:
        ...
        while not message_over:
            ...
            message_over = chunk.endswith(end_code)

        # Yeah maybe an endcode is a lil inefficient here...
        chunk = chunk.strip(end_code)
        ...
        print("Server says: {}".format(chunk.strip(end_code))) 
